    ...
    <Card sx={{ margin: 1 }}>
      <CardContent>
        ...
        <Typography>
          ...
          and deployed in{" "}
          <Link href="https://www.digitalasset.com/products/daml-hub" target="_blank">
            Daml Hub
          </Link>
          ...
          already has basic knowledge of Daml. You can view the full repo for this application{" "}
          <Link
